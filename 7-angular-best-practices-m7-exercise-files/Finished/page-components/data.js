...
app.value('schedule', [
  { id: 1, name: 'Aquatic Juggling', credits: 4, instructorName: 'Professor Snape' },
  { id: 2, name: 'Ancient Philistine Music', credits: 2, instructorName: 'Professor Snape' },
  { id: 3, name: 'Advanced Ninja Killing Blows', credits: 5, instructorName: 'Professor Snape' }
]);
